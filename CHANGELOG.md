...
#### 5-4 App2app 1
- IT팀 담당자는 시스템의 API를 등록할 수 있다.
- IT팀 담당자는 캘린터 시스템이 회의실 예약 시스템의 예약 기능에 접근이 가능하게 허용한다.
- IT팀 담당자는 회의실 시스템이 캘린더 시스템의 사용자 캘린더 조회 접근이 가능하게 허용한다.
